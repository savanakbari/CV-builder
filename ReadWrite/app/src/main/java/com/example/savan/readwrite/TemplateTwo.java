...
/*
Main activity for template two
 */
...
public class TemplateTwo extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_template_two, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.clear:
                this.finish();
                startActivity(new Intent(this,TemplateTwo.class));
                break;
        }
        return false;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_template_two);
        ...
        write.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                FileOperationsTwo fop = new FileOperationsTwo();
